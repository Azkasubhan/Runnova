...
const INITIAL: ChatEntry = {
  role: "bot",
  text: 'Hello! I\'m Nova AI Assistant. I can help explain machine health, RUL predictions, sensor readings, and maintenance recommendations.\n\nTry asking:\n• "Why is Motor_3 critical?"\n• "What is the RUL of Pump_1?"\n• "Show sensor data"\n• "Fleet overview"\n• "What should I do?"',
};
...
export default function AssistantPage() {
  ...
  return (
    <MainLayout title="Nova AI Assistant">
      <div className="flex h-full">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          >
            ...
            <button
              type="submit"
              className="p-2 bg-cyan-600 hover:bg-cyan-500 rounded-md transition-colors"
            >
        ...
        <div className="w-64 flex-shrink-0 border-l border-[#1e2d3d] bg-[#111827] p-4 space-y-4 overflow-y-auto hidden lg:block">
          <div>
            <h3 className="text-[#556677] text-[10px] uppercase tracking-wider mb-2">
              Context Machine
            </h3>
            ...
            <div className="space-y-1.5">
              {machines.map((m) => (
                ...
                >
                  ...
                  <span
                    className={
                      m.prediction.status === "Critical"
                        ? "text-red-400 font-semibold"
                        : m.prediction.status === "Warning"
